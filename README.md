...
It is intentionally orphaned from `main` and contains only the static site. GitHub Pages serves this branch directly: **push to `docs` is the deploy**.
...
Source: **Deploy from a branch**. Branch: **`docs`**. Folder: **`/ (root)`**.
